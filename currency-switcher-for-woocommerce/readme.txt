...
1. Upload the entire `/currency-switcher-for-woocommerce` directory to the `/wp-content/plugins/` directory.
2. Activate Currency Switcher for WooCommerce through the 'Plugins' menu in WordPress.
